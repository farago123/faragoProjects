...
public class SinglyLinkedList<T> implements Iterable<T> {
	...
	*/
    ...
    {
		System.out.print(this.size + ": ");
		Entry<T> currentEntry = head.next;
		printListReverse2(currentEntry);
		System.out.println("");
	}

	public void printListReverse2(Entry<T> currentEntry)
	{
		if(currentEntry != null)
		{
			printListReverse2(currentEntry.next);
    ...
    public void recursivelyReverse()
    {
    	...
    	recursivelyReverse(prev, current, next);

    }

    public void recursivelyReverse(Entry<T> prev, Entry<T> current, Entry<T> next)
    {
    	if(current == null)
    	{
    		head.next = prev;
